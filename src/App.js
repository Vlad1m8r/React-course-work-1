...
import OldModel from "./components/Car/OldModel/OldModel";
import NewModel from "./components/Car/NewModel/NewModel";
import CarModelMenu from "./components/CarModelMenu/CarModelMenu";
import BysMenu from "./components/BysMenu/BysMenu";
        ...
        <BrowserRouter>
          <div className="App">
            <div className="App__head">
              ...
              <div className="App__head__menu" onClick={() => {history.push('/bys')}}>Бумажки</div>
              ...
              <div className="App__head__menu" onClick={() => {history.push('/')}}>Модельный ряд</div>
              {/*<div className="App__head__menu" onClick={() => {history.push('/stat')}}>Статистика</div>*/}
              <div className="App__head__menu" onClick={() => {history.push('/dealer')}}>Найти дилера</div>
            ...
            <div className="App__content">
              <BrowserRouter>
                ...
                <Switch>
                  ...
                  <Route path="/dealer/edit/:id"
                         exact
                         dealer={this.state.dealer}
                         component={(props) => <CreateDealer {...props}/>}
                  />
